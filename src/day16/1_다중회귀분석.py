...
운동시간         6.968463e-22       # p값이 0.05 이하 이므로 귀무가설 기각 할수 있다.
게임시간         5.508640e-28       # p값이 0.05 이하 이므로 귀무가설 기각 할수 있다.
'''
# [3] 학습된 모델 기준으로 새로운 샘플 체중을 예측하자. # 운동시간과 게임시간 을 알고 있는 상태에서 체중 예측하기
